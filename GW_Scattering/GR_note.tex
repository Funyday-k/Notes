...
We also need to introduce another kind of vector called \textbf{dual vector}. Since called "vector", it also satisfies such rules. However, what is different from normal vectors is that it constructs a kind of map from vectors to real numbers 
