...
On the basis of Def. \ref{def:dual}, we know the definition of dual vector is based on acting on vectors, so we also need to construct them in using coordinate basis vector. Therefore, 